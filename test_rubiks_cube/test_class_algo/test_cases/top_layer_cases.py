...
class TestTopLayer:
    ...
    def __init__(self) -> None:
        self.top_layer_test_case()
        
    def top_layer_test_case(self):
        ...
        out_t_1=np.array([[[2, 5, 3], [1, 1, 6], [1, 5, 1]],
                        [[6, 2, 4], [3, 3, 2], [2, 4, 3]],
                        [[5, 3, 1], [6, 4, 3], [1, 1, 4]],
                        [[6, 1, 4], [4, 2, 5], [2, 4, 2]],
                        [[3, 1, 3], [2, 5, 5], [5, 3, 4]],
                        [[6, 4, 5], [2, 6, 6], [6, 6, 5]]]).reshape(6,3,3)
        ...
        out_t_2=np.array([[[3, 6, 2], [1, 1, 5], [4, 1, 2]],
                        [[4, 6, 3], [2, 3, 1], [5, 5, 6]],
                        [[1, 5, 1], [6, 4, 4], [3, 4, 4]],
                        [[2, 1, 1], [6, 2, 5], [3, 4, 2]],
                        [[6, 3, 6], [2, 5, 3], [5, 2, 6]],
                        [[5, 3, 1], [3, 6, 4], [5, 2, 4]]]).reshape(6,3,3)
        ...
        out_t_3=np.array([[[1, 1, 1], [1, 1, 1], [5, 6, 6]],
                        [[2, 2, 2], [2, 2, 2], [4, 2, 2]],
                        [[4, 4, 4], [4, 4, 4], [4, 4, 6]],
                        [[3, 3, 6], [3, 3, 6], [1, 3, 3]],
                        [[5, 5, 5], [5, 5, 5], [3, 5, 5]],
                        [[1, 3, 3], [1, 6, 6], [2, 6, 6]]]).reshape(6,3,3)  
