...
class TestTopMiddle:
    ...
    def __init__(self) -> None:
        self.top_middle_test_case()
        
    def top_middle_test_case(self):
        ...
        out_t_1=np.array([[[3, 5, 6], [2, 1, 6], [2, 1, 2]],
                        [[3, 1, 2], [3, 3, 2], [6, 4, 3]],
                        [[6, 2, 6], [6, 4, 3], [1, 1, 2]],
                        [[4, 3, 5], [4, 2, 4], [5, 4, 5]],
                        [[3, 5, 1], [1, 5, 2], [4, 3, 1]],
        ...
        out_t_2=np.array([[[6, 6, 2], [3, 1, 5], [3, 1, 3]],
                        [[6, 1, 2], [2, 3, 1], [5, 5, 6]],
                        [[5, 6, 4], [6, 4, 4], [3, 4, 5]],
                        [[6, 5, 1], [6, 2, 4], [1, 3, 5]],
                        [[2, 3, 4], [3, 5, 2], [3, 2, 1]],
        ...
        out_t_3=np.array([[[5, 1, 3], [1, 1, 1], [1, 1, 1]],
                        [[5, 3, 3], [2, 2, 2], [2, 2, 2]],
                        [[1, 2, 2], [4, 4, 4], [4, 4, 4]],
                        [[5, 4, 4], [3, 3, 3], [3, 3, 3]],
                        [[1, 5, 5], [5, 5, 5], [2, 5, 4]],
