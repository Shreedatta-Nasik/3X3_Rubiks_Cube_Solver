...
class TestCaseUpLeft:

    in_matrix = []
    out_matrix = []

    def __init__(self) -> None:
        self.up_left_test_cases()

    def up_left_test_cases(self):
        # 1st testcase
        ...
        out_t_1 = np.array([[[4, 5, 3], [5, 1, 6], [1, 1, 2]],
                            [[6, 2, 4], [3, 3, 2], [6, 4, 3]],
                            [[5, 3, 1], [6, 4, 2], [1, 1, 3]],
                            [[2, 4, 5], [1, 2, 4], [6, 4, 5]],
                            [[6, 1, 3], [2, 5, 5], [2, 3, 4]],
                            [[2, 5, 4], [3, 6, 6], [1, 6, 5]]]).reshape(6, 3, 3)
        ...
        out_t_2 = np.array([[[1, 6, 2], [1, 1, 5], [2, 1, 3]],
                            [[4, 6, 3], [2, 3, 1], [5, 5, 6]],
                            [[1, 5, 4], [6, 4, 2], [3, 4, 6]],
                            [[2, 4, 5], [1, 2, 3], [2, 6, 1]],
                            [[5, 3, 6], [3, 5, 3], [3, 2, 6]],
                            [[5, 5, 4], [4, 6, 4], [1, 2, 4]]]).reshape(6, 3, 3)
        ...
        out_t_3 = np.array([[[6, 1, 1], [6, 1, 1], [6, 1, 1]],
                            [[2, 2, 2], [2, 2, 2], [2, 2, 2]],
                            [[4, 4, 5], [4, 4, 5], [4, 4, 5]],
                            [[3, 3, 3], [3, 3, 3], [3, 3, 3]],
                            [[1, 5, 5], [1, 5, 5], [1, 5, 5]],
                            [[4, 6, 6], [4, 6, 6], [4, 6, 6]]]).reshape(6, 3, 3)
